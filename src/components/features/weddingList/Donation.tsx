...
const Donation = () => {
  ...
  return (
    <div className="bg-white/90 italic pt-6 px-2 rounded-lg">
      ...
      >
        <div className="px-5 flex h-10 w-full max-w-[40px] items-center justify-center rounded-lg bg-primary bg-opacity-5 text-primary transition-all">
          {open ? <BiRightArrow /> : <BiRightArrow className="rotate-90" />}
        </div>
